...
namespace SQLiteDb
{
    public partial class SQLiteConn
    {
        ...
        public List<int> Getyears()
        {
            ...
            using (SQLiteRecordSet rs = ExecuteQuery("SELECT DISTINCT year FROM peliculas"))
            {
                while (rs.NextRecord())
                {
        ...
        public List<string> GetClasificaciones()
        {
            ...
            using (SQLiteRecordSet rs = ExecuteQuery("SELECT DISTINCT clasificacion FROM peliculas"))
            {
                while (rs.NextRecord())
                {
